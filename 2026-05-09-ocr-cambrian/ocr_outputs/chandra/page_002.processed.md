...
graph TD
    A["Common Crawl PDFs  
CC-MAIN-2021-21"] --> B["n = 7.9MM PDFs"]
    B --> C["Filter for PDFs Containing Forms  
PDF contains AcroForm or XFA"]
    C --> D["n = 762k PDFs"]
    D --> E["Form Consistency Filtering  
>0 widgets  
>0 non-button and non-signature widgets  
remove tiny widgets  
remove overlapping widgets  
remove out of bounds widgets"]
    E --> F["n = 59k PDFs"]
    F --> G["CommonForms  
59k PDFs ; 480k pages"]
